...
Alternatively, it may be a \code{FormulaUnit}, which contains a pointer to a separate \code{Formula} object.
...
These steps are called \bold{forward simplification} and \bold{backward simplification} and take care of applying simplification inferences, such as \emph{factoring}~\ref{subsec:factoring}, to the GC and to the active or passive clauses respectively.
