\chapter{Inference}\label{chap:second}
...
Where \(resolve\) is a function of type \(Clause \times Clause \to Clause | \bot\) that computes the resolvent of two clauses, or returns \(\bot\) if no matching literals can be found.
